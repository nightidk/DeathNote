...
import static ru.nightidk.deathnote.utils.AuthUtil.*;
...
public class ModEventListener {
    ...
    public static void cleanItemsTickEvent(MinecraftServer server) {
        ...
        List<ItemEntity> entityList = (List<ItemEntity>) level.getEntitiesByType(TypeFilter.instanceOf(ItemEntity.class), (i) -> {
